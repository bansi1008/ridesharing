...
import com.example.Repository.driverCheck;
...
public class Registerlayer {
    ...
    public String registerDriver(Registerdto register) {
        ...
        if (driverCheck.findByVehiclePlate(register.getVehiclePlate()).isPresent()) {
            throw new DuplicateResourceException("Vehicle plate already registered");
        }
